...
class CreateTiktokGmvDataTable extends Migration
{

    public function up()
    {
        Schema::create('tiktok_gmv_data', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedInteger('buyers')->nullable();
    ...
    {
        Schema::dropIfExists('tiktok_gmv_data');
    }
}
