...
return new class extends Migration
{
    ...
    {
        Schema::create('shopee_seller_center_iklanku_keyword_data', function (Blueprint $table) {
            $table->id();
            ...
            // Tambahan yang berbeda dengan iklanku biasa
            $table->string('keyword')->nullable(); # Kata Pencarian/Penempatan
            $table->string('matching_type')->nullable(); # Tipe Pencocokan
    ...
    {
        Schema::dropIfExists('shopee_seller_center_iklanku_keyword_data');
    }
};
