    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-auto">
                <div class="card">
                    <div class="card-body">
                        <table id="shopee-datatable" class="table table-sm table-responsive-sm">
                            <thead>
        ...
        <div class="col-auto">
            <div class="card">
                <div class="card-body">
                    <table id="meta-cpas-datatable" class="table table-sm">
                        <thead>
                            <tr class="header">
                                <th class="text-center align-middle">Data Group Name</th>
...
@section('script')
    @vite(['resources/js/pages/shopee/summary_v3.js'])
@endsection
