            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return dataTableHelper.columnSummaryV3(data);
                    }
                },
                {
                    targets: 2,
                ...
                },
                {
                    targets: 3,
                    render: function (data, type, row) {
                        return dataTableHelper.columnSummaryV3(data,"currency");
                    }
                }
            ],
            language: {
    ...
    function initializeOrUpdateMetaCpasDataTable(startDate1, endDate1, startDate2, endDate2, brandId) {
        ...
        metaCpasDataTableInstance = $('#meta-cpas-datatable').DataTable({
            ...
            columns: [
                ...
                { title: "GMV", data: "purchases_conversion_value" },
