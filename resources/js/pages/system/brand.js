...
$(document).ready(() => {
    ...
    if (!dataTableInstance) {
      dataTableInstance = $('#basic-datatable').DataTable({
        ...
        columns: [
          ...
          { title: "User Data Directory", data: "user_data_dir" },
          { title: "Profile", data: "profile_dir" },
          { title: "Download Directory", data: "download_directory" },
          { title: "Fast API URL", data: "fast_api_url" },
  ...
  async function deleteRow(id) {
    try {
      const response = await fetch(`/brand/destroy/${id}`, {
        method: "DELETE",
        headers: {
