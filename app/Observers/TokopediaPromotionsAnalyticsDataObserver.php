...
use App\Models\TokopediaPromotionAnalyticsData;
use App\Models\RawData;
use Illuminate\Support\Facades\Log;

class TokopediaPromotionsAnalyticsDataObserver
{
    public function created(RawData $rawData)
    {
        if ($rawData->type === 'tokopedia_promotion_analytics') {
            ...
            foreach ($jsonData as $dataItem) {
                try {
                    ...
                    $existingData = TokopediaPromotionAnalyticsData::where('promotion_id', $dataItem['ID'])
                    ...
                    TokopediaPromotionAnalyticsData::create([
                        ...
                        'new_customers' => $dataItem['New Customers'], 
