                ...
                try {
                    ...
                    if ($existingData) {
                        ...
                        $existingData->fill([
                            ...
                            'adds_to_cart' => $dataItem['Adds to cart (TikTok Shop)'],
                            'purchases' => $dataItem['Purchases (TikTok Shop)'],
                            'gross_revenue' => $dataItem['Gross revenue (TikTok Shop)'],
                            'checkouts_initiated' => $dataItem['Checkouts initiated (TikTok Shop)'],
                            'product_page_views' => $dataItem['Product page views (TikTok Shop)'],
