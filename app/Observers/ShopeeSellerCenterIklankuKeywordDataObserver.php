...
use App\Models\ShopeeSellerCenterIklankuKeywordData;
use App\Models\RawData;
use Illuminate\Support\Facades\Log;
use Carbon\Carbon;

class ShopeeSellerCenterIklankuKeywordDataObserver
{
    public function created(RawData $rawData)
    {
        if ($rawData->type === 'shopee_seller_center_iklanku_keyword') {
            ...
            foreach ($jsonData as $dataItem) {
                try {
                    ...
                    $existingData = ShopeeSellerCenterIklankuKeywordData::where('data_date', $rawData->data_date)
                        ->where('name', $dataItem['Nama Iklan'])
                        ->where('keyword', $dataItem['Kata Pencarian/Penempatan'])
                    ...
                    ShopeeSellerCenterIklankuKeywordData::create([
                        ...
                        //Tambahan Untuk Keyword
                        'keyword' => $dataItem['Kata Pencarian/Penempatan'],
                        'matching_type' => $dataItem['Tipe Pencocokan'],
