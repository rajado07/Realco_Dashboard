            ...
            foreach ($jsonData as $dataItem) {
                try {
                    ...
                    $percentageFieldsToReplace = [
                        'co_rate' => 'Click-to-order rate (LIVE)',
                        'ctr' => 'CTR',
                    ];
                    ...
                    TiktokLiveStreamingData::create([
                        ...
                        'revenue' => $dataItem['Gross merchandise value (LIVE) (Rp)'],
                        'products' => $dataItem['Products added'],
                        'different_products_sold' => $dataItem['Different Products Sold'],
                        'orders_created' => $dataItem['Created SKU orders'],
                        'orders_paid' => $dataItem['SKU orders (LIVE)'],
                        'unit_sales' => $dataItem['LIVE items sold'],
                        ...
                        'new_followers' => $dataItem['New followers (Creator video)'],
